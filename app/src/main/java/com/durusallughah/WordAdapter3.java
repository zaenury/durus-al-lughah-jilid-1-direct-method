...
public class WordAdapter3 extends ArrayAdapter<Word> {

    //Resource id for background color of list
    private int mColorResourceId;

    public WordAdapter3(Activity context, ArrayList<Word> words, int colorResourceId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //find the textview in list_item2 with id default_text_view
        ...
        //find the textview in list_item2 with id miwok_text_view
